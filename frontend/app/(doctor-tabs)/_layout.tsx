...
import { LayoutDashboard, Search, ClipboardList, FileText, Pill, Settings } from 'lucide-react-native';
...
export default function DoctorTabsLayout() {
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarActiveTintColor: '#0033A0', tabBarInactiveTintColor: theme.textSecondary,
      ...
      <Tabs.Screen name="lookup" options={{ title: 'Lookup', tabBarIcon: ({ color, size }) => <Search size={size} color={color} /> }} />
