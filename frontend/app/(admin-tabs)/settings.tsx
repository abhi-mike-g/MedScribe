...
import { ShieldCheck, Mail, Shield, Lock, LogOut } from 'lucide-react-native';
...
const s = StyleSheet.create({
  ...
  avatar: { width: 72, height: 72, borderRadius: 36, backgroundColor: '#ECEEFF', alignItems: 'center', justifyContent: 'center', marginBottom: Spacing.md },
  avatarText: { fontSize: FontSizes.xxl, fontWeight: '800', color: '#7A8BFF' },
  profileName: { fontSize: FontSizes.xl, fontWeight: '700', color: theme.textPrimary },
  profileRole: { fontSize: FontSizes.md, color: '#7A8BFF', fontWeight: '600', marginTop: 4 },
  dept: { fontSize: FontSizes.sm, color: theme.textSecondary, marginTop: 4 },
